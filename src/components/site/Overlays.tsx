  ...
  return (
    <div className="fixed bottom-[max(1.25rem,env(safe-area-inset-bottom))] right-[max(1rem,env(safe-area-inset-right))] z-40 flex flex-col items-end gap-2.5">
      <a
        ...
        className="inline-flex h-11 items-center gap-2 rounded-full bg-olive pl-3.5 pr-4 text-background shadow-lg shadow-olive/20 transition-transform hover:scale-105 active:scale-[0.98]"
      >
      ...
      <a
        ...
        className="flex h-10 w-10 items-center justify-center rounded-full bg-accent text-foreground shadow-md transition-transform hover:scale-105"
      >
